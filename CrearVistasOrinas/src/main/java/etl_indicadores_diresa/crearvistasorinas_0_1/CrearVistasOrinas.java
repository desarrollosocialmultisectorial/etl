...
package etl_indicadores_diresa.crearvistasorinas_0_1;
...
/**
 * Job: CrearVistasOrinas Purpose: CreaLasVistasOrinas<br>
 * Description: Crea vistas necesarias de la base de datos <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class CrearVistasOrinas implements TalendJob {
...
public String getBddiresa_Server(){
	...
	private final String jobName = "CrearVistasOrinas";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CrearVistasOrinas.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CrearVistasOrinas.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearVistasOrinas = new byte[0];
    static byte[] commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasOrinas = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasOrinas.length) {
				if(length < 1024 && commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasOrinas.length == 0) {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasOrinas = new byte[1024];
				} else {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasOrinas = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasOrinas, 0, length);
			strReturn = new String(commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasOrinas, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearVistasOrinas) {
...
query_tDBRow_1 = "CREATE or replace VIEW examenes_orina AS SELECT ate_NroDocumento,ate_FecAte,ate_FecParto,ate_edad ,ate_IdEESS FROM `i_a"
+"tencion`,i_atediagnosticos,i_ateprocedimientos WHERE ate_IdAtencion =adi_IdAtencion and apro_IdDiagnostico=adi_IdDiagnos"
+"tico and (apro_CodProcedimiento='81000' or apro_CodProcedimiento='81001' or apro_CodProcedimiento='81003' or apro_CodPro"
+"cedimiento='81004' or apro_CodProcedimiento='81005') ;";
 ...
 */
    ...
    public static void main(String[] args){
        final CrearVistasOrinas CrearVistasOrinasClass = new CrearVistasOrinas();

        int exitCode = CrearVistasOrinasClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CrearVistasOrinas.class.getClassLoader().getResourceAsStream("etl_indicadores_diresa/crearvistasorinas_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CrearVistasOrinas.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CrearVistasOrinas");
        }
...
/************************************************************************************************
 *     65300 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 de octubre de 2019 11:52:04 AM COT
 ************************************************************************************************/