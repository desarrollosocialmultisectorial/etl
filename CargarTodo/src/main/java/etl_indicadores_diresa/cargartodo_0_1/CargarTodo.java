...
package etl_indicadores_diresa.cargartodo_0_1;
...
/**
 * Job: CargarTodo Purpose: CargaTodosLosIndicadores<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class CargarTodo implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CargarTodo";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CargarTodo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		etl_indicadores_diresa.cargar_ind_01_pla_dci_0_1.Cargar_IND_01_PLA_DCI childJob_tRunJob_1 = new etl_indicadores_diresa.cargar_ind_01_pla_dci_0_1.Cargar_IND_01_PLA_DCI();
	    // pass DataSources
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ETL_INDICADORES_DIRESA_CargarTodo = new byte[0];
    static byte[] commonByteArray_ETL_INDICADORES_DIRESA_CargarTodo = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_INDICADORES_DIRESA_CargarTodo) {
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		etl_indicadores_diresa.cargar_ind_03_pla_dci_0_1.Cargar_IND_03_PLA_DCI childJob_tRunJob_2 = new etl_indicadores_diresa.cargar_ind_03_pla_dci_0_1.Cargar_IND_03_PLA_DCI();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		etl_indicadores_diresa.cargar_ind_04_pla_dci_his_0_2.Cargar_IND_04_PLA_DCI_HIS childJob_tRunJob_3 = new etl_indicadores_diresa.cargar_ind_04_pla_dci_his_0_2.Cargar_IND_04_PLA_DCI_HIS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		etl_indicadores_diresa.cargar_ind_05_pla_dci_his_1_2.Cargar_IND_05_PLA_DCI_HIS childJob_tRunJob_4 = new etl_indicadores_diresa.cargar_ind_05_pla_dci_his_1_2.Cargar_IND_05_PLA_DCI_HIS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		etl_indicadores_diresa.cargar_ind_07_pla_dci_his_0_2.Cargar_IND_07_PLA_DCI_HIS childJob_tRunJob_5 = new etl_indicadores_diresa.cargar_ind_07_pla_dci_his_0_2.Cargar_IND_07_PLA_DCI_HIS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		etl_indicadores_diresa.cargar_ind_08_pla_dci_his_0_3.Cargar_IND_08_PLA_DCI_HIS childJob_tRunJob_6 = new etl_indicadores_diresa.cargar_ind_08_pla_dci_his_0_3.Cargar_IND_08_PLA_DCI_HIS();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final CargarTodo CargarTodoClass = new CargarTodo();

        int exitCode = CargarTodoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CargarTodo.class.getClassLoader().getResourceAsStream("etl_indicadores_diresa/cargartodo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CargarTodo.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CargarTodo");
        }
...
/************************************************************************************************
 *     65189 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 de octubre de 2019 11:53:03 AM COT
 ************************************************************************************************/