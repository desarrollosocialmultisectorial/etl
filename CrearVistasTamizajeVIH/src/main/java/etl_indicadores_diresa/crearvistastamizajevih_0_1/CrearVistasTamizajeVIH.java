...
package etl_indicadores_diresa.crearvistastamizajevih_0_1;
...
/**
 * Job: CrearVistasTamizajeVIH Purpose: CreaLasVistasOrinas<br>
 * Description: Crea vistas necesarias de la base de datos <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class CrearVistasTamizajeVIH implements TalendJob {
...
public String getBddiresa_Server(){
	...
	private final String jobName = "CrearVistasTamizajeVIH";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CrearVistasTamizajeVIH.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CrearVistasTamizajeVIH.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH = new byte[0];
    static byte[] commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH.length) {
				if(length < 1024 && commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH.length == 0) {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH = new byte[1024];
				} else {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH, 0, length);
			strReturn = new String(commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearVistasTamizajeVIH) {
...
query_tDBRow_1 = "CREATE or replace VIEW  tamizaje_vih AS SELECT ate_NroDocumento,ate_FecAte,ate_FecParto,ate_edad ,ate_IdEESS FROM `i_at"
+"encion`,i_atediagnosticos,i_ateprocedimientos WHERE ate_IdAtencion =adi_IdAtencion and apro_IdDiagnostico=adi_IdDiagnost"
+"ico and (apro_CodProcedimiento='86701' or apro_CodProcedimiento='86702' or apro_CodProcedimiento='86703' or apro_CodProc"
+"edimiento='86689'); ;";
 ...
 */
    ...
    public static void main(String[] args){
        final CrearVistasTamizajeVIH CrearVistasTamizajeVIHClass = new CrearVistasTamizajeVIH();

        int exitCode = CrearVistasTamizajeVIHClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CrearVistasTamizajeVIH.class.getClassLoader().getResourceAsStream("etl_indicadores_diresa/crearvistastamizajevih_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CrearVistasTamizajeVIH.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CrearVistasTamizajeVIH");
        }
...
/************************************************************************************************
 *     65427 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 de octubre de 2019 11:52:36 AM COT
 ************************************************************************************************/