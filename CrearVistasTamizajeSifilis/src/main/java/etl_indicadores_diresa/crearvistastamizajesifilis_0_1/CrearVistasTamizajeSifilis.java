...
package etl_indicadores_diresa.crearvistastamizajesifilis_0_1;
...
/**
 * Job: CrearVistasTamizajeSifilis Purpose: CreaLasVistasOrinas<br>
 * Description: Crea vistas necesarias de la base de datos <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class CrearVistasTamizajeSifilis implements TalendJob {
...
public String getBddiresa_Server(){
	...
	private final String jobName = "CrearVistasTamizajeSifilis";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CrearVistasTamizajeSifilis.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CrearVistasTamizajeSifilis.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis = new byte[0];
    static byte[] commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis.length) {
				if(length < 1024 && commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis.length == 0) {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis = new byte[1024];
				} else {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis, 0, length);
			strReturn = new String(commonByteArray_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearVistasTamizajeSifilis) {
...
query_tDBRow_1 = "CREATE or replace VIEW  tamizaje_sifilis AS SELECT ate_NroDocumento,ate_FecAte,ate_FecParto,ate_edad ,ate_IdEESS FROM `"
+"i_atencion`,i_atediagnosticos,i_ateprocedimientos WHERE ate_IdAtencion =adi_IdAtencion and apro_IdDiagnostico=adi_IdDiag"
+"nostico and (apro_CodProcedimiento='86592' );";
 ...
 */
    ...
    public static void main(String[] args){
        final CrearVistasTamizajeSifilis CrearVistasTamizajeSifilisClass = new CrearVistasTamizajeSifilis();

        int exitCode = CrearVistasTamizajeSifilisClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CrearVistasTamizajeSifilis.class.getClassLoader().getResourceAsStream("etl_indicadores_diresa/crearvistastamizajesifilis_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CrearVistasTamizajeSifilis.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CrearVistasTamizajeSifilis");
        }
...
/************************************************************************************************
 *     65455 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 de octubre de 2019 11:52:25 AM COT
 ************************************************************************************************/