...
package etl_indicadores_diresa.crearmedicamentosacidofolicohierro_0_1;
...
/**
 * Job: CrearMedicamentosAcidoFolicoHierro Purpose: CreaLasVistasOrinas<br>
 * Description: Crea vistas necesarias de la base de datos <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class CrearMedicamentosAcidoFolicoHierro implements TalendJob {
...
public String getBddiresa_Server(){
	...
	private final String jobName = "CrearMedicamentosAcidoFolicoHierro";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CrearMedicamentosAcidoFolicoHierro.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CrearMedicamentosAcidoFolicoHierro.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro = new byte[0];
    static byte[] commonByteArray_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro.length) {
				if(length < 1024 && commonByteArray_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro.length == 0) {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro = new byte[1024];
				} else {
   					commonByteArray_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro, 0, length);
			strReturn = new String(commonByteArray_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_INDICADORES_DIRESA_CrearMedicamentosAcidoFolicoHierro) {
...
row3Struct row4 = row3;
	 ...
	 */
			...
			int NB_ITERATE_tDBConnection_1 = 0; //for statistics
...
+" `pun$dig`.`punto_base`\nFROM `pun$dig`\nlimit 1,128\n";
            ...
            row3.id_pundig = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row3.pundig_nom = null;
							} else {
	                         		
        	row3.pundig_nom = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row3.pundig_act = null;
							} else {
	                         		
        	row3.pundig_act = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row3.punto_idodsis = null;
							} else {
	                         		
        	row3.punto_idodsis = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row3.punto_base = null;
							} else {
	                         		
        	row3.punto_base = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
...
///////////////////////		
	    		...
	    		if(row3.pundig_nom != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.pundig_nom)							
				);
	    		...
	    		if(row3.pundig_act != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.pundig_act)							
				);
	    		...
	    		if(row3.punto_idodsis != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.punto_idodsis)							
				);
	    		...
	    		if(row3.punto_base != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.punto_base)							
				);
 ...
 */
	...
	currentComponent="tFlowToIterate_1";
            ...
            globalMap.put("row4.id_pundig", row4.id_pundig);
    	            
            globalMap.put("row4.pundig_nom", row4.pundig_nom);
    	            
            globalMap.put("row4.pundig_act", row4.pundig_act);
    	            
            globalMap.put("row4.punto_idodsis", row4.punto_idodsis);
    	            
            globalMap.put("row4.punto_base", row4.punto_base);
 ...
 */
	NB_ITERATE_tDBConnection_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate1", 1, "exec" + NB_ITERATE_tDBConnection_1);
					//Thread.sleep(1000);
				}				
	...
	currentComponent="tDBConnection_1";
		...
		String properties_tDBConnection_1 = context.bddiresa_AdditionalParams;
		...
		String url_tDBConnection_1 = "jdbc:mysql://" + context.bddiresa_Server + ":" + context.bddiresa_Port + "/" + ((String)globalMap.get("row4.punto_base")) + "?" + properties_tDBConnection_1;
		String dbUser_tDBConnection_1 = context.bddiresa_Login;
		
		
			
	final String decryptedPassword_tDBConnection_1 = context.bddiresa_Password; 
	...
	globalMap.put("db_tDBConnection_1",((String)globalMap.get("row4.punto_base")));
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate1", 2, "exec" + NB_ITERATE_tDBConnection_1);
						}				
...
query_tDBRow_1 = "CREATE or replace VIEW atencion_medicamento_acido_folico AS \nSELECT amed_IdMedicamento, amed_CantEntregada,ate_NroDocu"
+"mento,ate_FecParto,ate_FecAte,ate_IdEESS FROM `i_atemedicamentos`,i_atediagnosticos,i_atencion WHERE amed_CodMedicamento"
+" IN ('03513','36195','03512','03514','03552','03553') AND amed_IdDiagnostico=adi_IdDiagnostico AND ate_IdAtencion=adi_Id"
+"Atencion AND ate_IdServicio IN ('009','056')\n";
 ...
 */
    ...
    public static void main(String[] args){
        final CrearMedicamentosAcidoFolicoHierro CrearMedicamentosAcidoFolicoHierroClass = new CrearMedicamentosAcidoFolicoHierro();

        int exitCode = CrearMedicamentosAcidoFolicoHierroClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CrearMedicamentosAcidoFolicoHierro.class.getClassLoader().getResourceAsStream("etl_indicadores_diresa/crearmedicamentosacidofolicohierro_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CrearMedicamentosAcidoFolicoHierro.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CrearMedicamentosAcidoFolicoHierro");
        }
...
/************************************************************************************************
 *     65836 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 de octubre de 2019 11:51:53 AM COT
 ************************************************************************************************/